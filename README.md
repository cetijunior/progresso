...
- **Google Calendar (optional)** — a full navigable month view (toolbar → Calendar)
  merges every ticket date with your primary calendar's events, color-coded by kind;
  click a day to see what's on it. Push ticket dates (due / filming / publish) to the
